...
sostNum = 3;
accelPartsLow = zeros(sostNum, size(DataAcclrt, 2));
accelPartsHight = zeros(sostNum, size(DataAcclrt, 2));
accelPartsHight(1, :) = fix(DataAcclrt(1, :)./256);
accelPartsHight(2, :) = fix(DataAcclrt(2, :)./256);
accelPartsHight(3, :) = fix(DataAcclrt(3, :)./256);
accelPartsLow(2, :) = mod(DataAcclrt(1, :), 256);
accelPartsLow(3, :) = mod(DataAcclrt(2, :), 256);
accelPartsLow(1, :) = mod(DataAcclrt(3, :), 256);
