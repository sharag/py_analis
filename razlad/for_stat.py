...
len_win, len_win_bef, probabl_ps = max_probabil(surge_ps, win_size, surge_len)
x_mesh_bef_ps, y_mesh_bef_ps = np.meshgrid(len_win, len_win_bef)

# линейное изменение постоянной составляющей
len_win, len_win_bef, probabl_lin_ps = max_probabil(surge_lin_ps, win_size, surge_len)
